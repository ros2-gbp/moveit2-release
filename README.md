## moveit (rolling) - 2.15.2-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling moveit` on `Wed, 16 Sep 2026 17:15:02 -0000`
...
## moveit (lyrical) - 2.15.2-1

The packages in the `moveit` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical moveit` on `Wed, 16 Sep 2026 17:02:33 -0000`
...
## moveit (humble) - 2.5.10-1

The packages in the `moveit` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble -e moveit` on `Tue, 01 Sep 2026 17:59:57 -0000`
...
## moveit (lyrical) - 2.15.1-1

The packages in the `moveit` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical moveit` on `Sat, 29 Aug 2026 20:35:05 -0000`
...
## moveit (rolling) - 2.15.1-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling moveit` on `Sat, 29 Aug 2026 20:20:07 -0000`
...
## moveit (rolling) - 2.15.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release moveit --rosdistro rolling` on `Thu, 13 Aug 2026 07:39:36 -0000`
...
- upstream repository: https://github.com/moveit/moveit2.git
- release repository: https://github.com/ros2-gbp/moveit2-release.git
- rosdistro version: `2.14.1-2`
- old version: `2.14.1-2`
...
## moveit (lyrical) - 2.15.0-1

The packages in the `moveit` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical moveit` on `Wed, 12 Aug 2026 06:27:08 -0000`
...
- upstream repository: https://github.com/moveit/moveit2.git
- release repository: https://github.com/ros2-gbp/moveit2-release.git
- rosdistro version: `2.14.1-3`
- old version: `2.14.1-3`
- new version: `2.15.0-1`
...
## moveit (kilted) - 2.14.3-1

The packages in the `moveit` repository were released into the `kilted` distro by running `/usr/bin/bloom-release moveit --rosdistro kilted --edit` on `Thu, 12 Feb 2026 15:44:45 -0000`
...
## moveit (kilted) - 2.14.1-3

The packages in the `moveit` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted moveit` on `Tue, 13 Jan 2026 19:17:29 -0000`
...
## moveit (kilted) - 2.14.1-2

The packages in the `moveit` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted moveit` on `Tue, 13 Jan 2026 12:45:56 -0000`
...
## moveit (jazzy) - 2.12.4-1

The packages in the `moveit` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy moveit --edit` on `Fri, 05 Dec 2025 20:54:11 -0000`
...
## moveit (kilted) - 2.14.1-1

The packages in the `moveit` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted moveit` on `Tue, 09 Sep 2025 12:50:26 -0000`
...
## moveit (rolling) - 2.14.1-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling moveit` on `Tue, 09 Sep 2025 12:35:53 -0000`
...
## moveit (kilted) - 2.14.0-1

The packages in the `moveit` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted moveit` on `Tue, 01 Jul 2025 05:37:23 -0000`
...
## moveit (rolling) - 2.14.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling moveit` on `Tue, 01 Jul 2025 05:09:55 -0000`
...
## moveit (rolling) - 2.13.2-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling moveit` on `Wed, 16 Apr 2025 12:35:56 -0000`
...
The packages in the `moveit` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble moveit` on `Wed, 16 Apr 2025 02:36:52 -0000`
...
The packages in the `moveit` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy moveit` on `Sun, 16 Feb 2025 12:35:17 -0000`
...
The packages in the `moveit` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble moveit` on `Sun, 09 Feb 2025 17:41:46 -0000`
...
The packages in the `moveit` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble moveit` on `Sun, 29 Dec 2024 21:03:29 -0000`
...
The packages in the `moveit` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy moveit` on `Wed, 18 Dec 2024 13:47:00 -0000`
...
## moveit (rolling) - 2.12.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling moveit` on `Fri, 29 Nov 2024 15:58:56 -0000`
...
The packages in the `moveit` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy moveit` on `Fri, 29 Nov 2024 15:29:40 -0000`
...
The packages in the `moveit` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble moveit` on `Mon, 18 Nov 2024 10:44:46 -0000`
...
## moveit (rolling) - 2.11.0-1

The packages in the `moveit` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling moveit -e` on `Wed, 18 Sep 2024 08:42:44 -0000`
